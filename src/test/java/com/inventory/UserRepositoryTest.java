...
public class UserRepositoryTest {
	...
	private TestEntityManager entityManager;
	  ...
	  entityManager.find(Role.class, 1); User userBrian = new User(
	  "Peter","Pan","pan@shop.nl","123456"); userBrian.addRole(roleAdmin);
	...
	public void listAllUsers() {
	  ...
	  User user = new User( "Jane", "Joe", "jjoe@shop.nl",
	  ...
	  @Test public void testCountById() { Integer id = 5; Long
	...
	public void testUpdateUserDetails() {
		User userNamUser = repo.findById(45).get();	
				userNamUser.setEnabled(true);
				userNamUser.setEmail("pan-test@shop.nl");
